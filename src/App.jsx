  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center h-screen">
        <div className="card lg:card-side bg-base-100 shadow-sm w-96">
          <div className="card-body">
            <h2 className="flex justify-center items-center"><strong>ROBCOM</strong></h2>
            <p className="flex justify-center items-center">Enter your credentials to access your account</p>
